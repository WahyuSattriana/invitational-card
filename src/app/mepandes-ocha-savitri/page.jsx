...
import oldbg from "./images/old-background.jpg";
  ...
  return (
      <div className="box-border">
        <header className="h-screen flex flex-col justify-center items-center">
          <RevealWrapper className="flex flex-col items-center gap-10 my-10">
            <h1 className="font-aboreto text-xl text-white">MEPANDES</h1>
            <RevealList interval={60} delay={500} className="flex flex-col items-center gap-8">
          ...
          <RevealWrapper><p className="text-center font-baskervville m-5 text-white">Kami sangat mengharapkan kehadiran <br/> Bapak/Ibu/Saudara/i</p></RevealWrapper>
        ...
        <section id="section-one" className="min-h-screen bg-transparent flex items-center justify-center relative">
          <div className="flex items-center justify-center flex-col gap-10 my-5">
            <RevealList className="grid grid-cols-2 gap-1 w-80 h-56">
              <div className="relative">
                <Image alt="ocha" src={ochasm} fill className="rounded-md absolute object-cover"/>
              </div>
              <div className="relative">
                <Image alt="savitri" src={savitrism} fill className="rounded-md object-cover absolute"/>
              </div>
            </RevealList>
        ...
        <section className="min-h-screen bg-transparent relative flex items-center justify-center mb-5">
          <div className="flex items-center justify-center flex-col gap-10 my-5 md:flex-row">
        ...
        <section className="min-h-screen bg-transparent relative flex items-center justify-center">
          <div className="flex flex-col items-center justify-center gap-5">
            <div className="h-screen flex flex-col items-center justify-center gap-5">
              ...
              <div className="grid grid-cols-2 gap-1 w-80 h-5/6">
                <div className="relative col-span-2"><Image alt="gal1" src={gal1} fill className="rounded-md absolute object-cover"/></div>
                <div className="relative"><Image alt="gal2" src={gal2} fill className="rounded-md absolute object-cover"/></div>
                <div className="relative"><Image alt="gal3" src={gal3} fill className="rounded-md absolute object-cover"/></div>
                <div className="relative col-span-2"><Image alt="savitri" src={gal4} fill className="rounded-md absolute object-cover"/></div>
                <div className="relative"><Image alt="gal4" src={gal5} fill className="rounded-md absolute object-cover"/></div>
                <div className="relative"><Image alt="gal5" src={gal6} fill className="rounded-md absolute object-cover"/></div>
              </div>
            </div>
      ...
      {/* <Image fill alt="oldbg" quality={100} src={oldbg} sizes="cover" className="absolute object-cover -z-30"/> */}
      {/* <audio autoPlay loop>
